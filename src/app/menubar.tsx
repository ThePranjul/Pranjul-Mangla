    ...
    return (
        <div>
            <div className={`h-screen w-screen absolute inset-0 ${menu ? "z-20 bg-background" :"-z-10"} overflow-hidden`}>
                <Image alt="None" className={`absolute rotate-45 p_line -z-10 ${transitionLetter ? "" : "p_line_moved"}`} src={image_1} width="50" height="1"/>
                <Image alt="None" className={`absolute rotate-45 m_left -z-10 ${transitionLetter ? "" : "m_left_moved"}`} src={image_2} width="50" height="1"/>
                <Image alt="None" className={`absolute rotate-45 m_mid -z-10 ${transitionLetter ? "" : "m_mid_moved"}`} src={image_3} width="50" height="1"/>
                <Image alt="None" className={`absolute rotate-45 m_right -z-10 ${transitionLetter ? "" : "m_right_moved"}`} src={image_2} width="50" height="1"/>
                <Image alt="None" className={`absolute rotate-45 m_dot -z-10 ${transitionLetter ? "" : "m_dot_moved"}`} src={image_4} width="90" height="1"/>
                <Image alt="None" className={`absolute rotate-45 p_up -z-10 ${transitionLetter ? "" : "p_up_moved"}`} src={image_6} width="50" height="1"/>
            </div>
